...
function Navbar() {
  return (
    <div className='fixed z-[999] w-full px-20 py-5 font-["NeueMontreal"] flex justify-between items-center'>
        <div className='logo '>
        ...
        <div className='eleven flex items-center justify-center gap-8'>
        <div className='nav-items z-[999]'>
            <a className='text1 text-md capitalize font-light'>services</a>
            <a className='text2 text-md capitalize font-light'>services</a>
        </div>

        <div className='nav-items z-[999]'>
            <a className='text1 text-md capitalize font-light'>our work</a>
            <a className='text2 text-md capitalize font-light'>our work</a>
        </div>

        <div className='nav-items z-[999]'>
            <a className='text1 text-md capitalize font-light'>about us</a>
            <a className='text2 text-md capitalize font-light'>about us</a>
        </div>

        <div className='nav-items z-[999]'>
            <a className='text1 text-md capitalize font-light'>insights</a>
            <a className='text2 text-md capitalize font-light'>insights</a>
        </div>

        </div> 

        <div className='nav-items z-[999]'>
            <a className='text1 text-sm capitalize font-light'>contact us</a>
            <a className='text2 text-sm capitalize font-light'>contact us</a>
        </div>
        </div>
