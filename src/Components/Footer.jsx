...
function Footer() {
  return (
    <div className='w-full h-full flex'>
        <div className='sec1 h-[120vh] w-[50%] font-["Founders"] p-20 flex flex-col justify-between '>

        <div className='heading'>
        <h1 className='text-[9.5vw] uppercase leading-[5vw]'>eye-</h1>
        <h1 className='text-[9.5vw] uppercase leading-[9.5vw]'>opening</h1>
        </div>
        ...
        <div className='sec2 relative w-[50%] h-[120vh] flex flex-col gap-14 justify-center pt-16'>
        <h1 className='text-[10vw] uppercase font-semibold font-["Founders"] leading-[5vw]'>presentations</h1>

          <div className='dets flex flex-col'>
            <h1 className='font-["NeueMontreal"] text-md font-medium uppercase'>s:</h1>
            {["Instagram", "Behance", "Facebook", "Linkedin"] .map((item, index) => {
               return <div key={index} className='foot'>
                  <a className='font-["NeueMontreal"] text-sm font-medium' href='#'>{item}</a>
                </div>
            })}
          </div>

          <div className='dets flex flex-col gap-2'>
            <h1 className='font-["NeueMontreal"] text-md font-medium uppercase'>l:</h1>
            {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"] .map((item, index) => {
                return <div key={index} className='foot1'>
                  <a className='font-["NeueMontreal"] text-sm font-medium' href='#'>{item}</a>
                </div>
            })}
          </div>
          ...
          <div className='flex flex-col gap-2'>
            <h1 className='font-["NeueMontreal"] text-md font-medium uppercase'>e:</h1>
            <div className='detsh'>
            <a className='font-["NeueMontreal"] text-sm font-medium' href='#'>hello@ochi.design</a>
            </div>
          </div>

          <div className='dets4 flex gap-1 items-center text-[#21212162]'>
            <h1 className='font-["NeueMontreal"] text-sm font-medium'>© ochi design 2024.</h1>
            <div className='legal'>
            <a className='font-["NeueMontreal"] text-sm font-medium' href='#'>Legal Terms</a>
            </div>
          </div>

          <div className='dets absolute top-[53%] left-[80%] flex flex-col gap-2'>
            <h1 className='font-["NeueMontreal"] text-md font-medium uppercase'>m:</h1>
            {["Home", "Services", "Our Work", "About us", "Insights", "Contact us"] .map((item, index) => {
                return <div key={index} className='foot2'>
                  <a className='font-["NeueMontreal"] text-sm font-medium' href='#'>{item}</a>
                </div>
            })}
          </div>
